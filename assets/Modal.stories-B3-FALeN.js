import{j as e}from"./jsx-runtime-u17CrQMm.js";import{B as i,c as R}from"./Button-DMFs1kJ0.js";import{R as c,r as d}from"./iframe-DDYTsCUA.js";import{a as N}from"./index-CJceeV3S.js";import"./preload-helper-PPVm8Dsz.js";function D({state:n,send:t,ctx:r}){return{overlayProps:{onClick:s=>{s.target===s.currentTarget&&r.closeOnOverlayClick&&t({type:"CLOSE",payload:{source:"overlay"}})},"data-open":n.isOpen,"data-closing":n.isClosing},contentProps:{role:"dialog","aria-modal":!0,onKeyDown:s=>{s.key==="Escape"&&r.closeOnEscape&&t({type:"CLOSE",payload:{source:"escape"}})},onClick:s=>{s.stopPropagation()}},closeButtonProps:{onClick:()=>{t({type:"CLOSE",payload:{source:"button"}})},"aria-label":"닫기"}}}function I(n){const{open:t=!1,onOpenChange:r,closeOnOverlayClick:s=!0,closeOnEscape:l=!0}=n,u=c.useRef(r);c.useEffect(()=>{u.current=r},[r]);const[a,g]=c.useState({isOpen:t,isClosing:!1});c.useEffect(()=>{t&&!a.isOpen?g({isOpen:!0,isClosing:!1}):!t&&a.isOpen&&!a.isClosing&&g(p=>({...p,isClosing:!0}))},[t,a.isOpen,a.isClosing]),c.useEffect(()=>{if(a.isClosing){const p=setTimeout(()=>{g({isOpen:!1,isClosing:!1}),u.current?.(!1)},200);return()=>clearTimeout(p)}},[a.isClosing]);const W=c.useCallback(p=>{p.type==="CLOSE"&&a.isOpen&&!a.isClosing&&g(L=>({...L,isClosing:!0}))},[a.isOpen,a.isClosing]),P=c.useMemo(()=>({closeOnOverlayClick:s,closeOnEscape:l,onOpenChange:p=>{u.current?.(p)}}),[s,l]);return c.useEffect(()=>{if(a.isOpen){const p=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=p}}},[a.isOpen]),c.useMemo(()=>({...D({state:a,send:W,ctx:P}),isClosing:a.isClosing}),[a,W,P])}const V=["fixed inset-0 z-[1000] flex items-center justify-center","bg-black/60","transition-opacity duration-200 ease-in-out","opacity-0 pointer-events-none","data-[open=true]:opacity-100 data-[open=true]:pointer-events-auto","data-[closing=true]:opacity-0"],$=["relative bg-white rounded-[20px] p-6","max-w-[90vw] max-h-[90vh] overflow-auto","shadow-[0_0_8px_0_rgba(0,0,0,0.10),0_0_20px_0_rgba(0,0,0,0.10)]","transition-transform duration-200 ease-in-out","scale-95","data-[open=true]:scale-100","data-[closing=true]:scale-95"],K={small:"w-[400px]",medium:"w-[600px]",large:"w-[800px]"},G=["absolute top-4 right-4","w-8 h-8","flex items-center justify-center","border-none bg-transparent rounded cursor-pointer","text-gray-600","transition-colors duration-150 ease-in-out","hover:bg-gray-50","active:bg-gray-100","focus-visible:outline-2 focus-visible:outline-gray-700 focus-visible:outline-offset-2"],J=["mt-0 mb-4 text-xl font-semibold leading-7 text-gray-900"],A=d.createContext(null);function E(){const n=d.useContext(A);if(!n)throw new Error("Modal compound components must be used within Modal.Root");return n}function F({open:n,onOpenChange:t,closeOnOverlayClick:r=!0,closeOnEscape:s=!0,size:l="medium",children:u}){const a=I({open:n,onOpenChange:t,closeOnOverlayClick:r,closeOnEscape:s});if(!n&&!a.isClosing)return null;const g={open:n,api:a,size:l};return e.jsx(A.Provider,{value:g,children:u})}function _({className:n,children:t,...r}){const{api:s,open:l}=E();return e.jsx("div",{...s.overlayProps,"data-open":l,"data-closing":s.isClosing,className:R(V,n),...r,children:t})}function H({className:n,children:t,...r}){const{api:s,open:l,size:u}=E();return e.jsx("div",{...s.contentProps,"data-open":l,"data-closing":s.isClosing,className:R($,K[u],n),...r,children:t})}function q({className:n,children:t,...r}){const{api:s}=E();return e.jsx("button",{...s.closeButtonProps,className:R(G,n),...r,children:t??e.jsx(N.Close,{size:"md"})})}function Q({className:n,children:t,...r}){return e.jsx("h2",{className:R(J,n),...r,children:t})}function o({showCloseButton:n=!0,children:t,actionButton:r,...s}){return e.jsx(F,{...s,children:e.jsx(_,{children:e.jsxs(H,{children:[n&&e.jsx(q,{}),t,r&&e.jsx("div",{style:{marginTop:"32px",display:"flex"},children:e.jsx(i,{variant:"primary",onClick:r.onClick,full:!0,children:r.label})})]})})})}o.Root=F;o.Overlay=_;o.Content=H;o.CloseButton=q;o.Header=Q;o.__docgenInfo={description:"",methods:[{name:"Root",docblock:null,modifiers:["static"],params:[{name:`{
  open,
  onOpenChange,
...
}`,...w.parameters?.docs?.source}}};const te=["Default","Small","Medium","Large","WithoutCloseButton","DisableOverlayClick","DisableEscape","LongContent","WithForm","WithActionButton","AllSizes","CompoundPattern","CompoundCustomLayout","CompoundWithoutCloseButton","CompoundWithCustomOverlay","CompoundWithHeader"];export{M as AllSizes,k as CompoundCustomLayout,S as CompoundPattern,T as CompoundWithCustomOverlay,w as CompoundWithHeader,z as CompoundWithoutCloseButton,x as Default,j as DisableEscape,v as DisableOverlayClick,C as Large,O as LongContent,y as Medium,h as Small,b as WithActionButton,B as WithForm,f as WithoutCloseButton,te as __namedExportsOrder,ne as default};
